...
===============
										:::HiRGC:::
:::Java:::
>Compilation command: javac HiRGCModifiedUbuntu.java
>Execution command: java HiRGCModifiedUbuntu
...
where the target sequence is "t.fa" and the reference sequence is "r.fa",
...
# where the target sequence is "T1.fa" and the reference sequence is "R.fa"
...
# where percent = 20 (optional), parameters "compress" and "decompress" are used for compression and decompression, respectively, and R.fa is the reference file. All files to be compressed are contained in chr22.txt, with the exception of the reference file.
# -r is the reference (a FASTA file)
